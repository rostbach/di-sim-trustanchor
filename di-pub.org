...
#+LATEX_HEADER: \thesistype{draft-14a.11.2015 Master of Science thesis}
...
SIM-pohjaisen tunnistuksen teorian tueksi esitetään käytännössä
...
erollaan oleva älypuhelin. Päästäkseen hallintaverkkoon, on älypuhelimen
läpäistävä EAP-SIM tunnistus, mikä luo luottamusankkurin 


Tuloksena näytetään, että matkapuhelimella tehty tunnistautuminen luo 
luottamusankkurin ulkoisen edustajan ja kotiverkon välille ja 
avaa hallintayhteyden kotiverkkoon kotikäyttäjän valvonnassa.
...
#  - cloud :: here, BaaS (Parse) service running Internet
 - mobile (network) operator, MNO :: a mobile network operator, knows connection
...
needed.
# THIS IS in future chapter!
# as was mentioned in Section [[sec:pcsc]]. 

...
The goal is to make the smart phone the central, trusted controlling 
point, which connects outside world to home network for managing
purposes, while the normal access between the Internet and home network  stays unchanged.

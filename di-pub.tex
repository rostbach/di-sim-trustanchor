...
Figure\ref{fig:scenario-IV} shows the case when TMSI is used. TMSI can change
...
\caption{\label{fig:scenario-VI}In the future, CPE could be attached direct to the Cloud and AuthN comes from MNO}
\end{figure}

...
if it has to insert the admin role information in to the RADIUS message.
It knows for sure only originating server. For the MNO, it  does not
necessary know about the roles.

...
explained in section [[sec:disconnections]].
# [picture?]
...
#  [-> see later, if synch. section written],
...
[
http://www.smartjac.biz/webstore/samples-to-order/smartjac-test-sim-configurable-options ]

...
That information may include VLAN separation or time of forced
logout, basically what the access point and smartphone would later need.
...
middle, MiTM) and tries to inject untruthful messages, Message
Authenticator with MD5 digesting might help in detecting
that. 

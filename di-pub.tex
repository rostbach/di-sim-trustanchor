...
smartphone, AP, Authentication server and MNO is described in
...
presented in Figure \ref{fig:sim-pre}. The real operator and its HLR was 
planned to be replaced in gateway at home network and real phone
with its simulator counterpart.
...
Changes were in the end done \# for example (with SSH or)

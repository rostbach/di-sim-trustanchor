...
\thesistype{draft-20.8.2015 Master of Science thesis}
...
4 (Figure\ref{fig:eap-sim-radius}). The client later checks in the process
...
\caption{\label{fig:scenario-I}Scenario I with 3 separate domains: BaaS, MNO and home net}
\end{figure}
...
\caption{\label{fig:scenario-IV}Scenario IV, AuthZ from BaaS, AuthN from home network}
\end{figure}
...
\section{Estimating time to authenticate EAP-SIM [TO BE REMOVED]}
\label{sec-6-2}
...
\label{sec-6-5-2}
Integrity issues were handled in Section\ref{sec:radius-macs} describing

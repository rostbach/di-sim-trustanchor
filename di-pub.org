...
built upon that anchor. This anchored device later becomes home network's
Certificate Authority (CA) service. In the end, the rest of the home network 
devices apply for certificates from that CA to get under same
trust circle. 
 Behringer proposes that AuthN would happen likewise

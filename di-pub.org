...
only use a simple model of management network. Getting in to the management network is carried out at home network via EAP-SIM authentication and it is the key element of the thesis.

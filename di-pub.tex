...
\thesistype{draft-1.11.2015 Master of Science thesis}
...
\author{Riku Itäpuro}
\date{1.11.2015 \{30., 12., 8, 3.10., 28.,2.9., 20.,18.8.,27.7,11.5,7.5.to the github,28.4, 16.4, 13.4.2015 new-framing, 4.4, 27.3,  20.3, 7.3)}
...
but not tested in simulated environment.
 Disconnection issues are explained in Section
...
portal [-> reference to \texttt{No Internet connectivity} link is
\end{itemize}

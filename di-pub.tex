...
\thesistype{draft-24.10.2015 Master of Science thesis}
...
\section{Trust anchoring shortly explained}
\label{sec-3-5}
...
located on diverse place, as can be seen in Section \ref{sec-4-3}.
...
\item The Cloud send the changes to the Local Controller (phone) (2).
...
\caption{\label{fig:scenario-IV}Scenario IV. In the future CPE could be attached direct to the Cloud and AuthN comes from MNO}
\end{figure}
...
\section{Alternative management models (-> to discussion and speculations)}
\label{sec-4-6}
...
\section{Extension of the WPA2 supplicant to the real smartphone}
\label{sec-5-5}

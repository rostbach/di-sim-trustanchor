...
If that is done remotely, those requirements need adjustment.
Access 
Credentials: provision of credentials 
Knowledge: hire a service person.

 provided to  and  be configured remotely, if one has by different means but usually one needs 

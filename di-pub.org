...
Light than full, fast re-authentication would use temporal identity TMSI. 
Figure[[fig:scenario-IV]] shows the case when TMSI is used. TMSI can change
...
but Full authentication would not work here because of missing MNO.

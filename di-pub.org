...
#+DATE: 29.10.2015 {12., 8, 3.10., 28.,2.9., 20.,18.8.,27.7,11.5,7.5.to the github,28.4, 16.4, 13.4.2015 new-framing, 4.4, 27.3,  20.3, 7.3)
...
#+LATEX_HEADER: \thesistype{draft-29.10.2015 Master of Science thesis}
...
Routers know, how to connect different segments and how the path from 
segment A to segment B. Normally, they can control access to the segments with aid of 
...
role.  Decision can happen at the border of  network or specific
segment 

Here, once a user has been authorized into a management network, access
...
An example of a complex solution would be a traditional firewall and packet
inspection in the interconnects, but modern model
would be a de-perimeterization trend set originally by Open Group's
...
AuthN, and AuthZ in five scenarios. The scenarios are not inclusive,
but represented here as a model. The locations are marked as (i)

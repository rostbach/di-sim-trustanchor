...
ensuring that they are written correctly. [write more clear and
mention key distribution problem.]
...
\begin{description}
\item[{Response Authenticator}] =MD5(Code |ID |Length | Request Authenticator | \\
\end{description}
Attributes|Secret)

...
\ref{sec-5}.
Results are discussed on Chapter \texttt{\#cha:discussion} and Chapter \texttt{\#cha:conclusion} concludes the
thesis.
...
partly in Section \texttt{sec:disconnections}.
...
the home network and how then the change management can flow.

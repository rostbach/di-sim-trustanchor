...
the authentication is done using an extendable authentication profile (EAP) and a SIM-card
and how the authorization is checked with the {RADIUS} protocol.
% A theory, how EAP-SIM-authentication can be used at home is presented and a simulated environment
A theory to use EAP-SIM-authentication at home is presented and a simulated testbed
...
Authentication claims are tranported with WPA2 Enterprise.

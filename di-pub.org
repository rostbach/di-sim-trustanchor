...
positive side effect, two-factor AuthN from a hardware based SIM will
strengthen an existing security.
Finally, the  cloud management tools can be developed further to enjoy 
trust anchor on the smartphone and aid in resolving issues in 
future homes networks.

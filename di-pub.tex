...
\thesistype{draft-2.11.2015 Master of Science thesis}
...
\author{Riku Itäpuro}
\date{2.11.2015 \{1, 30., 12., 8, 3.10., 28.,2.9., 20.,18.8.,27.7,11.5,7.5.to the github,28.4, 16.4, 13.4.2015 new-framing, 4.4, 27.3,  20.3, 7.3)}
...
interface code made by Jolla, open source components from Mer (MEego
Reinvented, or meritocratic community), and some other software
...
processor easy.
[cross compile environment, little bit more, examples. SDK,
script,strips ]
...
network's Certificate Authority (CA) service and the trust anchor,
upon which the rest of the home network devices would apply for
certificates from to get under the same trust circle.  Key creation,

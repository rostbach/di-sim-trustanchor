...
#+DATE: 12.10.2015  {8.10.,3.10., 28.9., 2.9., 20.8.,18.8.,27.7,11.5,7.5.to the github,28.4, 16.4, 13.4.2015 new-framing, 4.4, 27.3,  20.3, 7.3)
...
#+LATEX_HEADER: \thesistype{draft-12.10.2015 Master of Science thesis}
...
and therefore incompatible with each other to fully benefit from
the centralization. 
...
The AA components and can appear in 
diverse location combinations. Here the AuthN component 
is usually located outside the home, as AuthN is the MNO, unless
we are considering offline AuthN or recurring AuthN.
# The Authenticator or 
The AuthZ on the other hand
may be placed more freely. It can be at home, at an external provider, 
or at MNO.
...
1) Changes are delivered from cloud to smartphone, which forwards them
   ...
   authentication has succeeded. This is here chosen method.
...
Needham-Schroeder protocol. Another bootstrapping architecture is
...
In the end, the changes in the management network are possible from
...
The smartphones were Nokia E70-1, Nokia E90, and Jolla. Nokias
featured EAP-SIM by factory, but Jolla had missing library and
configuration on its WPA-supplicant for SIM.

...
admin users, and APs are set to factory default. Scenario therefore
needs pre-configuring and bootstrapping  after which it
can become any of scenarios I-IV, but CPE  has first neither trust nor roles. Bootstrapping is discussed in 

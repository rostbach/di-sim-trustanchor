...
part, where a nonce, selected version, and 
an identity were sent from the phone (message 7 in Figure[[fig:eap-sim-radius]],
, but RADIUS server did not know how to handle them. 

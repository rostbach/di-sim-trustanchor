...
Using tickets has a connection to earlier studies on homenets. 
...
gives the device a ticket of authorization similar to Needham-Schröder
based Kerberos implementations. Device presents that ticket to CPE which

...
#+LATEX_HEADER: \thesistype{draft-16.11.2015 Master of Science thesis}
...
(mersdk in following represent the private SSH key of type RSA)
#+BEGIN_EXAMPLE
# ssh -l mersdk -p 2222 \
...
libpcsclite.so.1 library were copied to jolla phone, which was
...
#+END_EXAMPLE
From here the same tests could be now run on the smartphone that

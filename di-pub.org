...
It always is internal, located at home network.
...
Scenario IV (Figure[[fig:scenario-IV]]) is similar to scenario I presented
earlier, but now AuthZ is checked from the Cloud by CPE instead of MNO. If there is no connection to

...
thesis.  Although the smartphone provides alternativue authentication
...
The goal is to make the smart phone a central, trusted controlling 
point for managing purposes, while the normal access between the
Internet and home network stays unchanged.

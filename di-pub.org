...
LangatonTampere. Their users could use network anywhere, where there
was the same uniform SSID
(Service Set IDentifier) seen as published Wi-Fi network name.

 Later, those groups agreed to allow network visiting

...
Here are  5 scenarios presented for possible locations of AuthN and 
...
#+CAPTION: Cisco's view of 802.1x access control with EAP [To be removed from final]
...
method by mobile phone and that also sets smartphone to a trust anchor.

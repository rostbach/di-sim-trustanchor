...
\thesistype{draft-23.7.2015 Master of Science thesis}
...
encryption between the smart phone and AP by negotiating session keys
...
\caption{\label{fig:cisco-802.1x}Cisco's view of 802.1x auth [To be removed from final]}
\end{figure}

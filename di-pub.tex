...
When this is compared with Figure \ref{fig:eap-sim-radius} we see, that the runs got only to the
message 7, where a nonce, selected version, and
an identity 

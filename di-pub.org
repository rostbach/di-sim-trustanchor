...
#+LATEX_HEADER: \thesistype{draft-18.8.2015 Master of Science thesis}
...
same trust circle in the home network? 
...
an important factor.  
Also the key distribution problem mentioned in Chapter[[cha:intro]] is  solved
already at SIM-card distribution phase. 
As AuthN-AuthZ at home proceeds
through the Authenticator, maybe the Authenticator can deliver this

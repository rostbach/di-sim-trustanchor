...
#+DATE: 4.11.2015 {2a,1, 30., 12., 8, 3.10., 28.,2.9., 20.,18.8.,27.7,11.5,7.5.to the github,28.4, 16.4, 13.4.2015 new-framing, 4.4, 27.3,  20.3, 7.3)
...
#+LATEX_HEADER: \thesistype{draft-4.11.2015 Master of Science thesis}
...
Local controller   AP               Managed device (Router)
     ...
     |                                       |
#+end_src
#+CAPTION: Managed device trusts AP, who has authorized Local controller
...
needed, as was mentioned in Section[[#pcsc]]. So first pcsc-lite was

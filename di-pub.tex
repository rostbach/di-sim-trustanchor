...
\thesistype{draft-11.5.2015 Master of Science thesis}
...
Connecting these devices to the net remains easy, but managing the
...
One model of that is to separate the management and control function 
away from the connectivity and routing issues\cite{ifip2015}.
